...
class Scanner {
    ...
    static {
        Scanner.keywords = {};
        Scanner.keywords.and = TokenType_1.TokenType.AND;
        Scanner.keywords.class = TokenType_1.TokenType.CLASS;
        Scanner.keywords.else = TokenType_1.TokenType.ELSE;
        Scanner.keywords.false = TokenType_1.TokenType.FALSE;
        Scanner.keywords.for = TokenType_1.TokenType.FOR;
        Scanner.keywords.fun = TokenType_1.TokenType.FUN;
        Scanner.keywords.if = TokenType_1.TokenType.IF;
        Scanner.keywords.nil = TokenType_1.TokenType.NIL;
        Scanner.keywords.or = TokenType_1.TokenType.OR;
        Scanner.keywords.print = TokenType_1.TokenType.PRINT;
        Scanner.keywords.return = TokenType_1.TokenType.RETURN;
        Scanner.keywords.super = TokenType_1.TokenType.SUPER;
        Scanner.keywords.this = TokenType_1.TokenType.THIS;
        Scanner.keywords.true = TokenType_1.TokenType.TRUE;
        Scanner.keywords.var = TokenType_1.TokenType.VAR;
        Scanner.keywords.while = TokenType_1.TokenType.WHILE;
    }
    constructor(source) {
        this.source = source;
        this.tokens = [];
    ...
    handleNumberToken() {
        ...
        this.addToken(TokenType_1.TokenType.NUMBER, Object(Number(this.source.substring(this.start, this.current))));
    }
    peekNext() {
    ...
    handleStringToken() {
        ...
        this.addToken(TokenType_1.TokenType.STRING, Object(result));
    }
    match(expectedChar) {
        if (this.isAtEnd())
            return false;
